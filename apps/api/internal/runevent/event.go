...
const (
	...
	TypeWorkerAttemptStarted Type = "worker_attempt_started"
	TypeWorkerAttemptFailed  Type = "worker_attempt_failed"
	TypeWorkerRetryScheduled Type = "worker_retry_scheduled"
	TypeWorkerDeadLettered   Type = "worker_dead_lettered"
